...
import com.ywg.androidtools.widget.metaballloading.MetaballDebugView;
import com.ywg.androidtools.widget.metaballloading.MetaballView;
...
public class MetaballLoadingActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metaball_loading);
