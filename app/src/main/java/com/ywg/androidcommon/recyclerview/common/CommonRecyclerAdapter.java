...
public abstract class CommonRecyclerAdapter<T> extends RecyclerView.Adapter<CommonViewHolder> {
    ...
    public interface OnItemClickListener{
        void onItemClick(CommonViewHolder holder, int position);
    }

    public interface OnItemLongClickListener{
        boolean onItemLongClick(CommonViewHolder holder, int position);
    }
    ...
    public CommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == R.layout.adapter_view_header_layout){
            return new CommonViewHolder(mHeaderLayout);
        }

        if (viewType == R.layout.adapter_view_footer_layout){
            return new CommonViewHolder(mFooterLayout);
        }
        ...
        return new CommonViewHolder(itemView, viewBinder);
    }
