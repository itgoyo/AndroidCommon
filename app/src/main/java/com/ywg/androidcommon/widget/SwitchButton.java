...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs){
        ...
        if(attrs != null && getContext() != null){
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButton1);
            if(typedArray != null){
                withTextInterval = (int) typedArray.getDimension(R.styleable.SwitchButton1_withTextInterval, 0.0f);
                setDrawables(
                    typedArray.getDrawable(R.styleable.SwitchButton1_frameDrawable),
                    typedArray.getDrawable(R.styleable.SwitchButton1_stateDrawable),
                    typedArray.getDrawable(R.styleable.SwitchButton1_stateMaskDrawable),
                    typedArray.getDrawable(R.styleable.SwitchButton1_sliderDrawable)
                );
                typedArray.recycle();
            }
        }
