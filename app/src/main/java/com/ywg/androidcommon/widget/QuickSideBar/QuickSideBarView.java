...
public class QuickSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mTextColor = a.getColor(R.styleable.QuickSideBarView_qsbv_textColor, mTextColor);
            mTextColorChoose = a.getColor(R.styleable.QuickSideBarView_qsbv_textColorChoose, mTextColorChoose);
            mTextSize = a.getDimension(R.styleable.QuickSideBarView_qsbv_textSize, mTextSize);
            mTextSizeChoose = a.getDimension(R.styleable.QuickSideBarView_qsbv_textSizeChoose, mTextSizeChoose);
            mItemHeight = a.getDimension(R.styleable.QuickSideBarView_qsbv_itemHeight, mItemHeight);
            a.recycle();
        }
    }
