package com.ywg.androidcommon.widget.test;
...
public class PaintBoard extends View {
    ...
    private void obtainStyledAttr(AttributeSet attrs) {
        ...
        try {
            ...
            mBoardColor = array.getColor(R.styleable.PaintBoard_paintBoardColor, getResources().getColor(android.R.color.white));
            mPaintColor = array.getColor(R.styleable.PaintBoard_paintPaintColor, getResources().getColor(android.R.color.black));
