...
public class CirclePoint extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mColor= array.getColor(R.styleable.CirclePoint_pointcolor, getResources().getColor(R.color.colorPrimary));
        isRandom = array.getBoolean(R.styleable.CirclePoint_israndom, false);
        array.recycle();
    }
