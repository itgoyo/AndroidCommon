...
public class SpecialProgressBarView extends View {
    ...
    public SpecialProgressBarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSize =  typedArray.getDimension(R.styleable.SpecialProgressBarStyle_spb_textSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, getResources().getDisplayMetrics()));
        progressBarHeight = typedArray.getDimension(R.styleable.SpecialProgressBarStyle_spb_progressBarHeight, dip2px(getContext(), 4));
        textColorSuccess = typedArray.getColor(R.styleable.SpecialProgressBarStyle_spb_textColorSuccess, Color.parseColor("#66A269"));
        textColorError = typedArray.getColor(R.styleable.SpecialProgressBarStyle_spb_textColorError, Color.parseColor("#BC5246"));
        textColorNormal = typedArray.getColor(R.styleable.SpecialProgressBarStyle_spb_textColorNormal, Color.parseColor("#491C14"));
        startDrawable = typedArray.getResourceId(R.styleable.SpecialProgressBarStyle_spb_startDrawable, R.drawable.ic_get_app_white_36dp);
        endSuccessDrawable = typedArray.getResourceId(R.styleable.SpecialProgressBarStyle_spb_endSuccessDrawable, R.drawable.ic_done_white_36dp);
        progressBarBgColor = typedArray.getColor(R.styleable.SpecialProgressBarStyle_spb_progressBarBgColor, Color.parseColor("#491C14"));
        progressBarColor = typedArray.getColor(R.styleable.SpecialProgressBarStyle_spb_progressBarColor, Color.WHITE);
        isCanReBack = typedArray.getBoolean(R.styleable.SpecialProgressBarStyle_spb_canReBackable, true);
        isCanDrag = typedArray.getBoolean(R.styleable.SpecialProgressBarStyle_spb_canDragable,true);
