package com.ywg.androidcommon.utils.imageloader;
 ...
 * .build();
 */
public class FrescoImageLoaderUtil {
     ...
     */
    private FrescoImageLoaderUtil(LoadImageFrescoBuilder frescoBuilder) {
...
//            builderM.setRoundingParams(RoundingParams.asCircle());
    ...
    public static class LoadImageFrescoBuilder {
         ...
         * @return
         */
        public FrescoImageLoaderUtil build() {
...
//            }
            ...
            return new FrescoImageLoaderUtil(this);
        }
