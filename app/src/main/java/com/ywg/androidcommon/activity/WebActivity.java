...
import com.ywg.androidcommon.utils.DisplayUtil;
import com.ywg.androidcommon.utils.LogUtil;
import com.ywg.androidcommon.utils.StringUtil;
    ...
    private WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
               // LogUtils.e("ErrorCode:{}, ErrorMessage:{}", errorCode, description);
            }
        }
        ...
        public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
               // Logger.e("HttpStatusCode:{}, HttpErrorMessage:{}", errorResponse.getStatusCode(), errorResponse.getReasonPhrase());
            }
        }
    };
