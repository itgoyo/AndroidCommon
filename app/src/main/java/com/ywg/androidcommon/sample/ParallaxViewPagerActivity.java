...
public class ParallaxViewPagerActivity extends AppCompatActivity {
    ...
    private void initViewPager() {
        PagerAdapter adapter = new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                Glide.with(ParallaxViewPagerActivity.this).load(mImages[position % mImages.length]).into(imageView);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_parallax_viewpager, menu);
        return true;
    }
