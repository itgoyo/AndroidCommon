package com.ywg.androidcommon.sample.SpaceNavigationView;
...
import com.ywg.androidcommon.widget.SpaceNavigationView.SpaceItem;
import com.ywg.androidcommon.widget.SpaceNavigationView.SpaceNavigationView;
import com.ywg.androidcommon.widget.SpaceNavigationView.SpaceOnClickListener;
        ...
        adapter.setRecyclerClickListener(new RecyclerAdapter.RecyclerClickListener() {
            ...
            public void onClick(int position) {
                if (position == 0) {
                    ...
                    spaceNavigationView.showBadgeAtIndex(1, 4, ContextCompat.getColor(SpaceNavigationViewActivity.this, R.color.badge_background_color));
