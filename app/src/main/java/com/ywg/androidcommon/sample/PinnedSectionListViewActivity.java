...
import com.ywg.androidcommon.widget.PinnedSectionListView;

import java.util.Locale;

public class PinnedSectionListViewActivity extends ListActivity implements View.OnClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_pinnedsection_listview, menu);
