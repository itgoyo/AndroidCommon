...
import com.ywg.androidcommon.widget.InfiniteCycleViewPager.VerticalInfiniteCycleViewPager;
...
public class HorizontalPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        if (mIsTwoWay) {
            ...
            Utils.setupImage(mContext, (ImageView) view.findViewById(R.id.image), LIBRARIES[position]);
        }
