...
import com.ywg.androidcommon.widget.NavigationTabBar.NavigationTabBar;
...
public class HorizontalCoordinatorNtbActivity extends AppCompatActivity {
    ...
    public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
            final View view = LayoutInflater.from(getBaseContext()).inflate(R.layout.item_list_ntb, parent, false);
