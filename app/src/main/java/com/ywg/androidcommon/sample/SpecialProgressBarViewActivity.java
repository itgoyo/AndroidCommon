...
import com.ywg.androidcommon.widget.SpecialProgressBarView;

import java.lang.ref.WeakReference;

public class SpecialProgressBarViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_progress_bar_view);
