...
import com.ywg.androidcommon.photopicker.view.SuperCheckBox;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_ok:
                ...
                setResult(ImagePicker.RESULT_CODE_ITEMS, okIntent);
                finish();
                break;
            case R.id.btn_back:
                Intent backIntent = new Intent();
                backIntent.putExtra(ImagePreviewActivity.ISORIGIN, isOrigin);
                setResult(ImagePicker.RESULT_CODE_BACK, backIntent);
                finish();
                break;
        }
    }
